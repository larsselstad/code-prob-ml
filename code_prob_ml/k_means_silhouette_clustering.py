# source: https://colab.research.google.com/github/probml/pyprobml/blob/master/notebooks/book1/21/kmeans_silhouette.ipynb
...
FIG_DIR = "figures/k_means_silhouette_clustering/"
...
plt.tight_layout()
plt.savefig(FIG_DIR + "kmeans_distortion_vs_k.png", dpi=300)
...
plt.tight_layout()
plt.savefig(FIG_DIR + "kmeans_silhouette_vs_k.png", dpi=300)
...
for model in kmeans_per_k:
    ...
    fname = f"kmeans_silhouette_diagram{K}.png"
    plt.tight_layout()
...
for model in kmeans_per_k:
    ...
    fname = f"kmeans_silhouette_dboundaries{K}.png"
    plt.tight_layout()
    plt.savefig(FIG_DIR + fname, dpi=300)
