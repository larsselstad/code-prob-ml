# source: https://github.com/probml/pyprobml/blob/master/notebooks/book1/16/smoothingKernelPlot.ipynb
import numpy as np
...
plt.savefig("figures/kernel_plot/smoothingKernelPlot.png")
