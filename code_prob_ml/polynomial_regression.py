# soucre: https://github.com/probml/pyprobml/blob/master/notebooks/book1/01/linreg_poly_vs_degree.ipynb
...
plt.xlabel("degree")
plt.ylabel("mse")
plt.savefig("figures/polyfitVsDegree.png")
...
for deg in chosen_degs:
    ...
    plt.savefig("figures/polyfitDegree{}.png".format(deg))
...
for deg in chosen_degs:
    ...
    plt.savefig("figures/polyfitDegreeResiduals{}.png".format(deg))
...
for deg in chosen_degs:
    for train in [True, False]:
        ...
        plt.savefig("figures/polyfitDegreeFitVsActual{}-{}.png".format(deg, dataset))
