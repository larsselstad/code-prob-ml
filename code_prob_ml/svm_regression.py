# source: https://github.com/probml/pyprobml/blob/master/notebooks/book1/17/svm_regression_1d.ipynb
...
def plot_svm_regression(svm_reg, X, y, axes):
    ...
    plt.plot(x1s, y_pred, "k-", linewidth=2, label=r"")
...
for i, eps in enumerate(epsilons):
    ...
    plt.title(r"".format(svm_reg1.C, svm_reg1.epsilon), fontsize=18)
    plt.ylabel(r"", fontsize=18, rotation=0)
    plt.sca(axes[1])
    plot_svm_regression(svm_reg2, X, y, [-1, 1, 0, 1])
    plt.title(r"".format(svm_reg2.C, svm_reg2.epsilon), fontsize=18)
    fname = "figures/svm_regression/svm_regression_e{}.pdf".format(eps_names[i])
