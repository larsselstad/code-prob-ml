# source: https://github.com/probml/pyprobml/blob/master/notebooks/book1/04/linreg_poly_ridge.ipynb
...
plt.ylabel("mse")
plt.savefig("figures/ridge_regression/polyfitVsRidge.png")
...
for i, alpha in enumerate(chosen_alphas):
    ...
    plt.savefig("figures/ridge_regression/polyfitRidge{}.png".format(i))
